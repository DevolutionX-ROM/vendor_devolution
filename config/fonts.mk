...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/devolution/prebuilt/product/fonts,$(TARGET_COPY_OUT_PRODUCT)/fonts) \
    vendor/devolution/prebuilt/product/etc/fonts_customization.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/fonts_customization.xml
